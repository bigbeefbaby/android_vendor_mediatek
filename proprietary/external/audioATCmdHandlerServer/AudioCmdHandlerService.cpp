...
static void DoCustGainParam(AudioCmdParam &audioCmdParams, void *pParam, AudioCmdHandler *pAudioHandle)
{
    int ret = ACHFailed;
    int dataLen = 0;
...
static void DoCustBTGAINParam(AudioCmdParam &audioCmdParams, void *pParam, AudioCmdHandler *pAudioHandle)
{
    int ret = ACHFailed;
    int dataLen = 0;
...
//                        		mAduioCmdParams.param2 = 0;
					...
					case EDISPITEM_CMD:
						...
						break;
					case EGAIN_CMD:
						DoCustGainParam(mAduioCmdParams, (void *)pRecvData, pAudioCmdHandler);
						break;
					case EDISPBTNREC_CMD:
						DoGetBtNrecInfoForDisp(mAduioCmdParams, (void *)pRecvData, pAudioCmdHandler);
						break;
					case EBTGAIN_CMD:
						DoCustBTGAINParam(mAduioCmdParams, (void *)pRecvData, pAudioCmdHandler);
						break;
#endif
                }
            }

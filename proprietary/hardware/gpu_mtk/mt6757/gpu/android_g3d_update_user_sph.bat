...
adb shell rm /system/lib/hw/gralloc.mt6757.so
adb shell rm /system/lib64/hw/gralloc.mt6757.so

adb push ./user/gralloc.mt6757.so /system/lib/hw
adb push ./user64/gralloc.mt6757.so /system/lib64/hw

adb shell chmod 755 /system/lib/hw/gralloc.mt6757.so
adb shell chmod 755 /system/lib64/hw/gralloc.mt6757.so

...
LOCAL_C_INCLUDES += \
    ...
    $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/legacy/platform/mt6757/inc/acdk \
    $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/legacy/platform/mt6757/acdk/inc/cct \
    $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/legacy/platform/mt6757/acdk/inc/acdk \
    ...
    $(TOP)/device/mediatek/mt6757/kernel-headers \
